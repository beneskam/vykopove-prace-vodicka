...
const jsonLd = {
  ...
  description:
    "Profesionální zemní a výkopové práce, kanalizační a vodovodní přípojky, terénní úpravy a demolice. Přes 20 let zkušeností na infrastrukturních projektech po celé České republice.",
  foundingDate: "2005",
  priceRange: "$$",
  areaServed: {
    "@type": "Country",
